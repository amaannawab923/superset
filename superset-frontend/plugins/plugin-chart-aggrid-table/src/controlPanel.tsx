  ...
  controlPanelSections: [
    ...
    },
    {
      ...
      controlSetRows: [
        ...
        [
          {
            ...
            config: {
              ...
              default: true,
              description: t(
                'Enables filtering on individual table columns on both chart and dashboard views. Filters that are saved in the chart view will be visible to dashboard viewers by default.',
              ),
            },
          },
        ],
        ...
        [
          {
            name: 'show_raw_record_totals',
            config: {
              type: 'CheckboxControl',
              label: t('Show summary'),
              default: false,
              description: t('Show total aggregations of numeric columns.'),
              visibility: isRawMode,
              renderTrigger: true,
              resetOnHide: false,
            },
        ...
        [
          {
            ...
            config: {
              ...
              renderTrigger: true,
              description: t(
                'Persisted state of the table, contains applied filters, column widths etc.',
              ),
            },
          },
        ],
