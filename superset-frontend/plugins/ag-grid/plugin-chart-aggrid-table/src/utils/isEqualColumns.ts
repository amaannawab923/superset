...
export default function isEqualColumns(propsA: any[], propsB: any[]) {
  const a = propsA[0];
  const b = propsB[0];
  return (
    ...
    areObjectsEqual(
      a.formData.columnConfig || null,
      b.formData.columnConfig || null,
    ) &&
    ...
    areObjectsEqual(
      a.formData.extraFilters || null,
      b.formData.extraFilters || null,
    ) &&
    areObjectsEqual(
      a.formData.extraFormData || null,
      b.formData.extraFormData || null,
    ) &&
    areObjectsEqual(
      a.rawFormData.column_config || null,
      b.rawFormData.column_config || null,
    )
  );
}
